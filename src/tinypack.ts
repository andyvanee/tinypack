...
export class TinypackError extends Error {}

export const tinypack = (input: string | null) => {
    if (!input) throw new TinypackError('No input provided.')
    ...
    function localModulePath(path: string, from?: string): string {
        ...
        throw new TinypackError(`Cannot find module '${path}'.`)
    }
    ...
    function npmModulePath(pkg: string, from: string): string {
        ...
        throw new TinypackError(`Cannot find module '${pkg}'.`)
    }
    ...
    if (diagnostics.length) {
        ...
        throw new TinypackError('Errors.')
    }
